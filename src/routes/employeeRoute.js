...
const {getAllEmployee,getProfileEmployee,getDetailEmployee, updateEmployee, countEmployee} = require("../controller/employeeController")

router.get('/all',getAllEmployee)
router.get('/count/employee',countEmployee)
