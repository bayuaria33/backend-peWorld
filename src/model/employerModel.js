...
const getAllEmployer = (data) => {
  ...
  let qry = `SELECT users.id, users.name, users.email, users.phone, employer.company_name as company_name, employer.company_photo as photo, employer.company_field as field, employer.company_info as info, employer.province_name as province, employer.city_name as city 
    FROM users
